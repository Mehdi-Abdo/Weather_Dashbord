    ...
    <div className='w-full h-screen  text-white px-8'>
      <nav className='w-full p-3 flex justify-between items-center'>
        ...
        <div className='bg-white w-[15rem] overflow-hidden shadow-2xl rounded flex items-center p-2 gap-2'>
          <img src={search} alt="search"  onClick={submitCity} className='w-[1.5rem] h-[1.5rem] cursor-pointer ' />
          <input onKeyUp={(e) => {
            if (e.key === 'Enter') {
              // sumit the form
              submitCity()
      ...
      <div className='flex flex-row text-white bg-slate-700 tracking-wide '>
        <GpsFixedIcon/>
