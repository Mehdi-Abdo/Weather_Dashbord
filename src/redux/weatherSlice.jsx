...
export const GetHours = createAsyncThunk("api/GetHours", async () => {
...
export const GetLatLon = createAsyncThunk(
  "api/GetLatLon",
  async () => {
    const url = `http://api.openweathermap.org/geo/1.0/direct?q=rabat&appid=891386664a64a4ab04e363e0aa0c4b1d`;
    try {
      const response = await axios.get(url);
